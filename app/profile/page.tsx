      ...
      <div className="pulse-panel mx-auto max-w-4xl rounded-2xl p-10">
        <div className="flex items-center gap-5">
          <img
            src={user.avatar}
            alt="Steam avatar"
            className="h-16 w-16 rounded-full border-2 border-[var(--red-primary)] bg-[var(--bg-tertiary)]"
          />
            ...
            <div className="mt-4">
              ...
              {hasPriority && (
                <p className="mt-3 text-sm text-[var(--text-secondary)]">
                  Your {priorityLabels[priorityTier]} is active and will sync with the Priority Queue automatically.
                </p>
              )}
              {!hasPriority && (
                <p className="mt-3 text-sm text-[var(--text-secondary)]">
                  You do not currently have Silver, Gold, or Crimson queue priority.
                </p>
              )}
            </div>
            <Link
              href="/subscriptions"
              className="pulse-button mt-8 w-full border border-[var(--red-primary)] px-5 py-3 text-[var(--red-primary)] hover:bg-[var(--red-primary)] hover:text-white"
            >
